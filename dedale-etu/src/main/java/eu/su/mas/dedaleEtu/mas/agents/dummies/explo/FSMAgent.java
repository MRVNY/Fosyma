...
public class FSMAgent extends AbstractDedaleAgent {
	...
	private static final String send = "SendMes";
	private static final String receive = "ReceiveMes";
	...
	protected void setup(){
		...
		//Trans
		fsm.registerDefaultTransition(explo,send);
		fsm.registerDefaultTransition(send,receive);
		fsm.registerDefaultTransition(receive,send);
		fsm.registerTransition(send,send,SENT);
		fsm.registerTransition(receive,explo,SENT);
		fsm.registerTransition(send,explo,RECEIVED);
